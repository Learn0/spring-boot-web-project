package shop.ourshopping.social;
...
// 간편 로그인 플랫폼 종류에 따라 알맞은 Key로 프로필 정보를 가져옴
@Getter
@Setter
public class OAuthAttributes {
	...
	private static OAuthAttributes ofKakao(String userNameAttributeName, Map<String, Object> attributes) {
		Map<String, Object> kakao_account = (Map<String, Object>) attributes.get("kakao_account"); // 카카오로 받은 데이터에서 계정
																									...
																									// kakao_account 값을
																									// 꺼낸다.
		Map<String, Object> profile = (Map<String, Object>) kakao_account.get("profile"); // 마찬가지로 profile(nickname,
																							// image_url.. 등) 정보가 담긴 값을
																							// 꺼낸다.

		return new OAuthAttributes(attributes, userNameAttributeName, (String) profile.get("nickname"),
				(String) kakao_account.get("email"), (String) profile.get("profile_image_url"));
	}
